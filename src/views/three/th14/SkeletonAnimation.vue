 ...
 * @LastEditors: loueibb
 * @LastEditTime: 2020-08-31 10:21:24
-->
<template>
  <div class="page-skeleton-animation">
...
export default {
  ...
  methods: {
    ...
    initModel() {
      ...
      loader.load("/server/loader/gltf/girl/scene.gltf", (gltf) =>{
        ...
        let obj = gltf.scene; //获取到模型对象

        this.meshHelper = new THREE.SkeletonHelper(obj);
